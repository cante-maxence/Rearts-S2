<template>
        ...
        <p>
            ...
            des modalités de mise à disposition du site et des services par Réarts et de définir les conditions
            d’accès et d’utilisation des services par « l'Utilisateur ». <br>
            ...
            https://rearts.fr se réserve le droit de modifier unilatéralement et à tout moment le contenu des
            présentes CGU. <br>
        </p>
        ...
        <p>
            ...
            Numéro de téléphone 0405684687 <br>
            Adresse e-mail : maxence.cante@edu.univ-fcomte.fr. <br>
            Le Directeur de la publication est : Cante Maxence <br>
            L'hébergeur du site https://rearts.fr est la société Infomaniak Network SA, 
        ...
        <p>
            Le site https://rearts.fr permet à l'Utilisateur un accès gratuit aux services suivants : <br>
                ...
                <ul class="mx-5">
                    <li>- Mise en relation parents-artistes (Messagerie)</li>
                    <li>- Vente d'œuvres</li>
                    <li>- Commerce en ligne</li>
                    <li>- Dons à des associations</li>
                </ul>

            Le site est accessible gratuitement en tout lieu à tout Utilisateur ayant un accès à Internet. <br>
            Tous les frais supportés par l'Utilisateur pour accéder au service (matériel informatique, logiciels, connexion Internet, etc.) sont à sa charge. <br>

            L’Utilisateur non membre n'a pas accès aux services réservés. <br> 
            Pour cela, il doit s’inscrire en remplissant le formulaire. En acceptant de s’inscrire aux services réservés, l’Utilisateur membre s’engage à fournir des informations sincères et exactes concernant son état civil et ses coordonnées, notamment son adresse email. <br>
            ...
            Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de https://rearts.fr. <br>
            Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans préavis. <br>
        ...
        <p>
            ...
            d'accès, de rectification, de suppression et d'opposition de ses données personnelles. <br>
        ...
        <p>
            ...
            La marque Réarts est une marque déposée par Réarts SAS.Toute représentation et/ou reproduction
            et/ou exploitation partielle ou totale de cette marque, de quelque nature que ce soit, est totalement prohibée. <br>
            ...
            Il s'engage à une utilisation des contenus du site dans un cadre strictement privé, toute utilisation à des fins commerciales et publicitaires est strictement interdite. <br>
        ...
        <p>
            ...
            Malgré des mises à jour régulières, le site https://rearts.fr ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. <br>
            De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site. <br>

            L'Utilisateur s'assure de garder son mot de passe secret. Toute divulgation du mot de passe, quelle que soit sa forme, est interdite. Il assume les risques liés à l'utilisation de son identifiant et mot de
            passe. Le site décline toute responsabilité. <br>

            Le site https://rearts.fr ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site. <br>
        ...
        <p>
           ...
           L’Utilisateur est informé que lors de ses visites sur le site, un cookie peut s’installer automatiquement sur son logiciel de navigation. <br>
            ...
            Certains cookies expirent à la fin de la visite de l’Utilisateur, d’autres restent. <br>
            L’information contenue dans les cookies est utilisée pour améliorer le site https://rearts.fr.
        ...
        <p>
           ...
           Dessins, œuvres. <br>
            ...
            conduite de l’internet) et les règles de droit en vigueur. <br>

            Le site peut exercer une modération sur les publications et se réserve le droit de refuser leur mise en
            ligne, sans avoir à s’en justifier auprès du membre. <br>
            ...
            dans le monde entier, sur tout support (numérique ou physique), pour la durée de la propriété intellectuelle. <br>
            ...
            Tout contenu mis en ligne par l'Utilisateur est de sa seule responsabilité. <br>
            L'Utilisateur s'engage à ne pas mettre en ligne de contenus pouvant porter atteinte aux intérêts de tierces personnes. 
            Tout recours en justice engagé par un tiers lésé contre le site sera pris en charge par l'Utilisateur. <br>
